...
if (isset($_SERVER['REQUEST_METHOD']) && $_SERVER['REQUEST_METHOD'] == 'GET') {
    if (isset($_GET['id'])) {
        $stmt = $conn->prepare('SELECT * FROM kids_data WHERE shelter_id=?');
        $stmt->execute(array($_GET['id']));
        $orphan_data = $stmt->fetchAll();



?> 
<link rel="stylesheet" href="css/orphans.css">
<div class=" align-items-center justify-content-center mr-auto home w-100 ">   
    ...
    <div class="our-work text-center mt-5">
      ...
      <?php foreach($orphan_data as $data){ ?>


      <div class=" col-lg-3 col-md-6">

				<a href="adoption-form.php?id=<?php echo $data['id']?>" data-lightbox="example-set">
        <div class="box mb-3 bg-white" data-work="<?php echo $data['name']?> Age: <?php echo $data['age']?>">
