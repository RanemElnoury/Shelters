...
if (isset($_SERVER['REQUEST_METHOD']) && $_SERVER['REQUEST_METHOD'] == "POST") {
  ...
  $sql = "INSERT INTO orphan_donation (money, creditnum, password,phone,shelter_id)  VALUES(?,?,?,?,?)";
...
<video autoplay muted loop id="myVideo">
  <source src="uploads/video (2160p).mp4" type="video/mp4">
</video>
...
<div class="content">
 ...
 <?php
    ...
    if (isset($_GET['id'])) {
        $stmt = $conn->prepare('SELECT id,name FROM orphan_shelters WHERE id=?');
...
<?php
 ...
 <div class="m-3">
    ...
    <label for="exampleInputnumber1" class="form-label">How Much Money</label>
    <input type="number" name="money" class="form-control" id="exampleInputnumber1" placeholder="Enter how much money for adoption" required="">
  </div>
  <div class="m-3">
    <label for="exampleInputnumber2" class="form-label">Credit Card Number</label>
    <input type="number" name="creditnum" class="form-control" id="exampleInputnumber2"placeholder="Enter your credit card number" required="">
  </div>
  <div class="m-3">
  ...
  <div class="m-3">
    <label for="exampleInputnumber4" class="form-label">Phone-Number</label>
    <input type="number" name="phone" class="form-control" id="exampleInputnumber4"  placeholder="Enter your Phone-Number" required="">
  </div>
