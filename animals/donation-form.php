...
if (isset($_SERVER['REQUEST_METHOD']) && $_SERVER['REQUEST_METHOD'] == "POST") {
  ...
  $sql = "INSERT INTO animal_donation (money, creditnum, password,phone,shelter_id)  VALUES(?,?,?,?,?)";
...
<video autoplay muted loop id="myVideo">
  <source src="uploads/pexels-mikhail-nilov-7469781 (1080p).mp4" type="video/mp4">
</video>
...
<div class="content">
 ...
 <?php
    ...
    if (isset($_GET['id'])) {
        $stmt = $conn->prepare('SELECT id,name FROM animals_shelters WHERE id=?');
