    ...
    <div class=" align-items-center justify-content-center mr-auto home w-100">   
       <div class="container h-100" >
        <div class=" col-lg-8 column align-items-center justify-content-center vertical-center">
          ...
          <p class="p-home my-3">Help Ous Find A New Home For A Pet</p>
          <!-- <button type="button" class="btn btn-light py-2 px-4">FIND A PET TO ADOPT</button> -->
        </div>
       </div> 
    </div>
...
<div class="mt-5 p-5 w-100 cont">
  <div class="container">
    <h2 style="font-size: 35px;font-weight: 500; color: black; text-align:center;" class="mt-5">Process to adopt a pet</h2>
    <p style="color: #707b8e;font-size: 15px; font-weight: 300;text-align:center;">The process to adopt a pet can vary depending on the specific policies and procedures of the animal shelter or rescue organization. However, <br> here is a general overview of the typical steps involved in adopting a pet</p>
  </div>
   <div class="container mt-5">
    <div class="row d-flex">
      ...
      <a href="" class="divs">
        ...
        <h4 style="font-size:20px; color: black;" class="mt-5">Pet selection</h4>
        <p style="color: #707b8e;font-size: 15px; font-weight: 300;">select your lucky pet</p>
      </a>
      </div>
      ...
      <a href=""class="divs">
        ...
        <p style="color: #707b8e;font-size: 15px; font-weight: 300;"> This meeting serves as an opportunity for the adopter to interact with shelter staff or volunteers, discuss their preferences and requirements for a pet, and potentially meet specific animals available for adoption</p>
      </a>  
    </div>
      ...
      <a href=""class="divs">
        ...
        <p style="color: #707b8e;font-size: 15px; font-weight: 300;">Bringing a new pet into a family through adoption involves several steps to ensure a smooth transition and successful integration into their new home.</p>
      </a>
      </div>
    </div>
   </div>
...
$('.owl-carousel').owlCarousel({
 ...
 ?> 
<link rel="stylesheet" href="css/animal-home.css" />
